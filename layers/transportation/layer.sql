...
RETURNS TABLE(osm_id bigint, geometry geometry, class text, ramp int, oneway int, layer int, brunnel TEXT, service TEXT) AS $$
    SELECT
        osm_id, geometry,
        CASE
    ...
    FROM (
        ...
        SELECT
            ...
            is_bridge, is_tunnel, is_ford, is_ramp, is_oneway, layer, z_order
        ...
        SELECT
            ...
            FALSE AS is_ramp, FALSE AS is_oneway, layer, z_order
